...
public class CudaDr_execution {
  ...
  void cuParamSetv(Frontend fe, Result res, String hfunc, int offset, String ptr, int numbytes)
      throws IOException {
  ...
  void cuParamSeti(Frontend FE, Result res, String hfunc, int offset, int value)
      throws IOException {
  ...
  void cuFuncSetBlockShape(Frontend FE, Result res, String hfunc, int x, int y, int z)
      throws IOException {
  ...
  void cuLaunchGrid(Frontend FE, Result res, String hfunc, int grid_width, int grid_height)
      throws IOException {
