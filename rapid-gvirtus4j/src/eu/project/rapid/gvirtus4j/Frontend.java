...
public final class Frontend {
    ...
    public static int Execute(String routine) throws IOException {
        ...
        System.out.println("Frontend-Execute - 1");
        ...
        System.out.println("Frontend-Execute - 2");
        ...
        System.out.println("Frontend-Execute - 3");
        ...
        System.out.println("Frontend-Execute - 4");
        ...
        System.out.println("Frontend-Execute - 5");

        outputStream.write(outBuffer);

        System.out.println("Frontend-Execute - 6");
        /**************/
		...
		*/
        ...
        int count;
//        do {
            count = in.read(inBuffer, 0, 12);
            System.out.println("Frontend-Execute - count=" + count);
//        } while (count != -1);

        System.out.println("Frontend-Execute - 7");

        int message = inBuffer[0];
        resultBufferSize = inBuffer[4];

        System.out.println("Frontend-Execute - 8");
