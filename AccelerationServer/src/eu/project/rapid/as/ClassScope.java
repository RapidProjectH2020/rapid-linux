...
public class ClassScope {
  ...
  /**
   * Given a class loader instance, returns all native libraries currently loaded by that class
   * loader.
   * 
   ...
   * 
   * @throws RuntimeException if the "loadedLibraryNames" field hack is not possible in this JRE
   */
  ...
  public static String[] getLoadedLibraries(final ClassLoader loader) {
    ...
    if (LIBRARIES_VECTOR_FIELD == null) {
      throw new RuntimeException("ClassScope::getLoadedLibraries() cannot be used in this JRE",
          CVF_FAILURE);
    }
   ...
   * 
   * @throws RuntimeException if the "loadedLibrayNames" field hack is not possible in this JRE
   */
